# -*- coding: utf-8 -*-
"""
Created on Mon May 13 21:17:20 2024
...
def transform_default_fund_and_currency(report_level_identifier, row):
    """Transforms ReportLevelIdentifier into DefaultFund and determines Currency based on specific rules."""
    mapping = {
        'Base': 'OMIClearing_DefaultFund',
...
def process_excel_files(folder_path):
    ...
    for file in files:
        ...
        for sheet in xl.sheet_names:
            if sheet.startswith('OMI_DataFile_') or sheet == 'OMI_AggregateDataFile':
                ...
                try:
                    ...
                    for index, row in df.iterrows():
                        ...
                        transformed_row['CCP'] = 'OMI Clearing'
                        ...
                        transformed_row['DefaultFund'] = "OMIClearing_DefaultFund"
...
def main():
    folder_path = r'C:\{Your Path}\CCP IOSCO Database\Raw Data\OMI Clearing'
    ...
    output_file = r'C:\{Your Path}\CCP IOSCO Database\Database\Compiled Datasets\OMI_CompiledData.xlsx'
